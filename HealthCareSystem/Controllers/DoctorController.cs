...
namespace HealthCareSystem.Controllers
{
    public class DoctorController : Controller
    {
        ...
        public DoctorController(IDoctorService doctorService, IAppointmentService appointmentService, IPatientService patientService, ITimeOffService timeOffService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dashboardViewModel = await BuildDashboardViewModelAsync(doctorId);
